...
<head>
	...
	<!-- 按需加载，选择此片头时方才加载 -->
	<link type="text/css" rel="stylesheet" href="./css/start_hearttree.css">
</head>
<body>
    <div id="blink">
	<strong>
	<div align="left" style="text-align:center;">
		<div id="lovetime"></div><!--恋爱时间，不需要可以删掉--> 
	</div>
</strong><strong>
...
<div id="div_container">
	...
	<div id="div_intersect">
		...
		<div id="div_is_inner">
		     	<!--樱花飘落-->
<script src="http://www.loveuid.cn/js/jquery.min.js"></script>
	...
	<div id='div_btn_container'>
		...
		<div id="div_btn_inner">
			...
			<div class="div_btn" id="div_music" onclick="music_switch()" style="">
				<!-- 音乐按钮部分 -->
				<img id='img_music' src='./image/music_note_big.png' style='width: 30px;-webkit-animation:music_play_rotate 1s linear infinite'>
...
<script>
	var tempRes = {"code":"0001","message":"操作成功",
		"data":{"id":314,
			"content":"亲爱的，如果我对你的爱，是一滴水滴，我愿把太平洋送给你。如果我对你的爱，是一粒沙子，我愿把干沙漠送给你。如果我对你的爱，是一丝光明，我愿把太阳系送给你。",
			"nextContent":"",
			"backgroundImg":"https://img.xjh.me/random_img.php?return=302",
...
<script src="./js/start_hearttree.js"></script>
<script>
